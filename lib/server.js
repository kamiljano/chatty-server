...
module.exports.Server = class {
  ...
  start() {
    return new Promise(resolve => {
      ...
      app.post('/users', schemaValidationMiddleware(usersEndpoint.create.schema), usersEndpoint.create.controller(userManager));

      app.get('/users/~', usersEndpoint.get.controller);
